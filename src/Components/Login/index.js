...
const Login = () => {
    ...
    return(
        ...
        <div style={{marginTop:"100px"}} className="border border-dark rounded  col-md-8 col-lg-5 bg-l p-5 ">
        ...
        <div className="mt-3"> 
               <button className="btn btn-primary btn-sm fs-5 mx-3 px-4 text-white mt-3" onClick={handleForgot}>Forgot Password?</button>
       
        <span className="mt-3"> 
               <button className="btn btn-success fs-5 mx-3 text-white mt-3 " onClick={handleActivation}>Account not activated?</button>
        </span> 
        </div> 
        </div>
        </div>
