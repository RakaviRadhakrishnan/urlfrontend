...
function CreateURL() {
 ...
 function handleSubmit(e){
  ...
  return (
    <>
     {/* <LogButton/> */}
      <h3 className="text-white fw-bold mb-3"> Short URL </h3> 
      <div className="container-fluid my-3 ">
        ...
        <div className=" border border-dark rounded col-sm-10 col-md-8 col-lg-8 bg-white p-3 ">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <button type="submit" className="btn btn-sm btn-success w-50 fw-bold mt-3">Create Short URL</button>
            </form>
        ...
        { urlData &&
        <table className="table table-primary table-striped table-responsive-sm w-75"> 
        <thead>
      <tr>
        <th scope="col">#</th>
